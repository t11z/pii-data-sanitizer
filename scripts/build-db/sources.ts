...
const LATIN: string[] = [
  ...
  'kobayashi',
  'murakami',
  // --- Armenian (romanized) — conventional transliterations of common given
  // names and distinctive -yan/-ian surnames. Native-script forms come from the
  // Wikidata (CC0) ingest (armenian.json); these high-frequency romanizations
  // give the Latin pack dual coverage. Kept unambiguous (no short common-word
  // collisions) so they stay precise in core tier.
  'aram',
  'armen',
  'tigran',
  'gevorg',
  ...
  'gasparyan',
  'khachaturian',
  // --- Georgian (romanized) — conventional transliterations of common given
  // names and distinctive -shvili/-dze/-adze surnames. Native-script forms come
  // from the Wikidata (CC0) ingest (georgian.json).
  'giorgi',
  'irakli',
  'nikoloz',
  'vakhtang',
